...
#### Дисклеймер
Автор не несёт ответственности за любой возможный ущерб, причинённый ПК, в результате использования данного проекта.  
Вы используете программу на свой страх и риск. В любом случае, для сброса BIOS до заводских настроек вы можете воспользоватся очисткой CMOS или сброса с помощью батарейки
****
