...
1.1. Скачайте последний релиз ```grubmod.```  <br>
1.2. Скачайте ТЕКУЩУЮ версию прошивки вашего биоса и поместите его в робочую папку. <br>
1.3. Передвиньте файл с прошивкой в ```UEFIToolNE.exe.```  <br>
1.4. В открытом окне нажмите комбинацию клавиш ```Ctrl + F``` . <br>
1.5. Выберите секцию ```Text``` , и напишите имя любого параметра например: ```ASPM``` . <br>
   
<p align="left">
  <img src="https://github.com/NZK95/grubmod/blob/master/assets/images/Usage/%231.png?raw=true">
</p>

1.6. После поиска, перейдите в любое вхождение. <br>
1.7. Выберите файл ```PE32 image section```  в разделе ```Setup``` , и нажмите на него ПКМ. <br>
1.8. В открытом окне нажмите ```Extract as is.``` <br>

<p align="left">
  <img src="https://github.com/NZK95/grubmod/blob/master/assets/images/Usage/%232.png?raw=true">
</p>

1.9. Сохраните файл в робочую директорию. <br>
